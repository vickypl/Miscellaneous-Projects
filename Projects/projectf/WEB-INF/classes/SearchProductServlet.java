...
public class SearchProductServlet extends GenericServlet{ 
  
 @Override  
 public void service(ServletRequest request,ServletResponse response)
	  throws ServletException,IOException{
     //step1  get user input data
	String searchProductName =    request.getParameter("search_product_name");
     //step2
	 //check record in db and fetch
	...
	htmlCode.append("<th>price</th>");
	htmlCode.append("<th>category</th>");
	htmlCode.append("<th>brandname</th>");
	...
	htmlCode.append("</tr>");
	 ...
	 try{
		...
		//******************************************
		String sql="SELECT * FROM PRODUCT where lower(name) like lower('%"+searchProductName+"%')  " ; 
	...
	while( rs.next() ){
			...
			htmlCode.append("<td>"+price+"</td>");
			htmlCode.append("<td>"+category+"</td>");
			htmlCode.append("<td>"+brandName+"</td>");
