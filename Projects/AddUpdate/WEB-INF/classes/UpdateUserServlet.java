...
public class UpdateUserServlet extends GenericServlet {
	...
	public void service(ServletRequest request, ServletResponse response) throws IOException, ServletException {
		...
		htmlCode.append("<hr>");
		htmlCode.append("<fieldset style='padding='70px;'>");
		htmlCode.append("<form action='update' method='post'>");
		htmlCode.append("UserId: <input type='text' name='new_id' value='"+uid+"' disabled>");
...
//db code end
		...
		updateInfo.append("<fieldset style='paddin: 60px; margin-top: 100px; margin-left: 300px; margin-right: 300px;'>");
