...
public class UserAddServlet extends GenericServlet {
	...
	public void service(ServletRequest request, ServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			String sql="insert into userdata(id, name, username, password, role) values(?,?,?,?,?)";
		...
		htmlCode.append("<hr>");
		htmlCode.append("<h1>Hellow world</h1>");
		htmlCode.append("<hr>");
		if (addInfo.length()>0) {
		...
		htmlCode.append("<fieldset style='paddin: 60px; margin-top: 100px; margin-left: 300px; margin-right: 300px;'>");
		htmlCode.append("<legend align='center'>UserDataAdded:</legend>");
		htmlCode.append("<h1>"+id+"</h1>");
		htmlCode.append("<hr>");
		htmlCode.append("<h1>"+name+"</h1>");
		htmlCode.append("<hr>");
		htmlCode.append("<h1>"+username+"</h1>");
		htmlCode.append("<hr>");
		htmlCode.append("<h1>"+password+"</h1>");
		htmlCode.append("<hr>");
		htmlCode.append("<h1>"+role+"</h1>");
