...
//   how to fetch init parameter cofig
     ...
     String trainerName=config.getInitParameter("trainer_name");//"sk";
     String trainerExp=config.getInitParameter("trainer_ex");//"+12";
     String trainerImg=config.getInitParameter("trainer_img");//"sk.jpg";
	 String javaTopic=config.getInitParameter("java_topic");//"data type , String,Array loop"; 
	 String htmlTopic=config.getInitParameter("html_topic");//null 
